...
const reviews = [
  [
    { id: 1, name: "John Doe", text: "This is a wider card with supporting text below.", time: "Last updated 3 mins ago", imgSrc: "/img/Ellipse 10.png" },
    { id: 2, name: "Jane Smith", text: "This card has supporting text below.", time: "Last updated 3 mins ago", imgSrc: "/img/Ellipse 10.png" },
    { id: 3, name: "Alice Johnson", text: "This card has even longer content.", time: "Last updated 3 mins ago", imgSrc: "/img/Ellipse 10.png" },
  ],
  [
    { id: 4, name: "Michael Brown", text: "Different card content for the second slide.", time: "Last updated 5 mins ago", imgSrc: "/img/Ellipse 10.png" },
    { id: 5, name: "Emily White", text: "Another set of cards in the carousel.", time: "Last updated 5 mins ago", imgSrc: "/img/Ellipse 10.png" },
    { id: 6, name: "David Wilson", text: "More cards appearing in the second slide.", time: "Last updated 5 mins ago", imgSrc: "/img/Ellipse 10.png" },
  ],
];
